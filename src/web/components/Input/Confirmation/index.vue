<template>
  <div class="flex gap-3 w-full max-w-[500px]">
      <input
        ...
        inputmode="numeric"
        maxlength="1"
        class=" h-14 md:h-20 min-w-0 flex-1 text-center text-xl font-semibold border border-grayScale-400 rounded-lg bg-grayScale-100 text-grayScale-900 transition-all outline-none focus:border-primary focus:drop-shadow disabled:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-60"
